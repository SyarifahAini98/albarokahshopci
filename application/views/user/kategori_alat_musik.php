      ...
      <span class="caret"></span>
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?= base_url('beranda_pelanggan/harga_terendah_alat_musik');?>">Harga Terendah</a></li>
                                <li class="divider"></li>
                                <li><a href="<?= base_url('beranda_pelanggan/harga_tertinggi_alat_musik');?>">Harga Tertinggi</a></li>
                                <li class="divider"></li>
                                <li><a href="<?= base_url('beranda_pelanggan/populer_alat_musik');?>">Populer</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
