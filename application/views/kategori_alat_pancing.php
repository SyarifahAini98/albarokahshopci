      ...
      <span class="caret"></span>
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?= base_url('beranda/harga_terendah_alat_pancing');?>">Harga Terendah</a></li>
                                <li class="divider"></li>
                                <li><a href="<?= base_url('beranda/harga_tertinggi_alat_pancing');?>">Harga Tertinggi</a></li>
                                <li class="divider"></li>
                                <li><a href="<?= base_url('beranda/populer_alat_pancing');?>">Populer</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
